...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      roles: ['Super Admin', 'MInT Admin', 'Regional Admin', 'Federal Admin', 'Institutional Admin', 'Chairman (CC)', 'Secretary (CC)']
    },
    {
    ...
    },
    {
      ...
      path: '/admin/users',
      roles: ['Super Admin', 'MInT Admin', 'Chairman (CC)', 'Regional Admin', 'Federal Admin', 'Institutional Admin']
    },
    {
